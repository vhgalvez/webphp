...
<?php
	...
	*/
	...
	$aColumnas = array('idc', 'usuario', 'contra', 'nombre', 'cedula','telefono', 'email','placa');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificarc.php?id=".$aRow['idc']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminarc.php?id=".$aRow['idc']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
