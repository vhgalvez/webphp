	...
	<div class="container">
		...
		<form class="form-horizontal" method="POST" action="updates.php" autocomplete="off">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="origen" class="form-control" id="origen" name="origen" placeholder="Origen"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="tel" class="form-control" id="destino" name="destino" placeholder="Destino"
