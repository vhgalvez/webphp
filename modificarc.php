		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="updatec.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="cedula" class="form-control" id="cedula" name="cedula" placeholder="Cedula" value="<?php echo $row['cedula']; ?>" >
					</div>
				</div>
				<div class="form-group">
					<label for="contra" class="col-sm-2 control-label">Contraseña</label>
					<div class="col-sm-10">
						<input type="contra" class="form-control" id="contra" name="contra" placeholder="Contraseña" value="<?php echo $row['contra']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="usuario" class="form-control" id="usuario" name="usuario" placeholder="Usuario" value="<?php echo $row['usuario']; ?>" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="placa" class="form-control" id="placa" name="placa" placeholder="Placa" value="<?php echo $row['placa']; ?>" >
					</div>
				</div>
