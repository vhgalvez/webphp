...
<?php
	...
	*/
	...
	$aColumnas = array( 'idu', 'nombres', 'cedula', 'email', 'telefono', 'origen', 'destino', 'tiempo');
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificars.php?id=".$aRow['idu']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminars.php?id=".$aRow['idu']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
